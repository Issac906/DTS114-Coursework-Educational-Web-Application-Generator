...
- Filter courses by difficulty level and category.
- Select courses that match your interests and current experience.
...
## Course Library
The application includes essential AI learning topics:
...
- Computer Vision
- Generative AI Product Studio
- MLOps and Deployment
- Responsible AI and Ethics

## How to Use the Planner
1. Browse the course library.
2. Use the search bar or filters to find relevant courses.
3. Select one or more courses.
4. Enter your name and learning goal.
...
## Privacy
Do not enter sensitive personal information. The application only needs a learner name or nickname and a learning goal to create a personalised suggestion.
